  ...
  ?>
    ...
    <div class="contenair shadow-sm rouded-4 py-4" style="margin:auto;margin-top: 100px; width:40%;background:white;">
        <div class="mb-1 text-center h3">
            <label for="floatingInput">Vérification d'un courtier</label>
        </div>

        <form class="p-4" action="controllercourtier.php" method="post">
            <div class="form-floating mb-3">
                ...
                <label for="floatingInput">Entrer ID Courtier</label>
            </div>
